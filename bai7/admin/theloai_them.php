<?php 
 ...
 if (isset($_POST['submit'])) {
 	...
 	$ten_theloai = filter_input(INPUT_POST, 'TenTL', FILTER_VALIDATE_INT);
 	$thutu = filter_input(INPUT_POST, 'ThuTu', FILTER_VALIDATE_INT);
 	$anhien = filter_input(INPUT_POST, 'AnHien', FILTER_VALIDATE_INT);
